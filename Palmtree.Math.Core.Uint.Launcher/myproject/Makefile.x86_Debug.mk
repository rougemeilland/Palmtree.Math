all: ../../dist/Debug/x86/Palmtree.Math.Core.Uint.Launcher.exe

clean:
	rm -f ../../dist/Debug/x86/Palmtree.Math.Core.Uint.Launcher.exe ../build/x86_Debug/Palmtree.Math.Core.Uint.Launcher.map
	rm -r -f ../build/x86_Debug

OBJS = ../build/x86_Debug/main.o ../../dist/Release/x86/Palmtree.Math.Core.Uint.dll

../../dist/Debug/x86/Palmtree.Math.Core.Uint.Launcher.exe: $(OBJS) 
	mkdir -p ../../dist/Debug/x86
	g++ -o ../../dist/Debug/x86/Palmtree.Math.Core.Uint.Launcher.exe $(OBJS)  -lkernel32 -luser32 -mconsole -Wl,--enable-stdcall-fixup -Wl,-Map=../build/x86_Debug/Palmtree.Math.Core.Uint.Launcher.map -LZ:/Sources/Lunor/Repos/rougemeilland/Palmtree.Math/dist/Release/x86/
