all: ../../dist/Release/x64/Palmtree.Math.Core.Uint.Launcher.exe

clean:
	rm -f ../../dist/Release/x64/Palmtree.Math.Core.Uint.Launcher.exe ../build/x64_Release/Palmtree.Math.Core.Uint.Launcher.map
	rm -r -f ../build/x64_Release

OBJS = ../build/x64_Release/main.o ../../dist/Release/x64/Palmtree.Math.Core.Uint.dll

../../dist/Release/x64/Palmtree.Math.Core.Uint.Launcher.exe: $(OBJS) 
	mkdir -p ../../dist/Release/x64
	g++ -o ../../dist/Release/x64/Palmtree.Math.Core.Uint.Launcher.exe $(OBJS)  -lkernel32 -luser32 -mconsole -Wl,--enable-stdcall-fixup -Wl,-Map=../build/x64_Release/Palmtree.Math.Core.Uint.Launcher.map -LZ:/Sources/Lunor/Repos/rougemeilland/Palmtree.Math/dist/Release/x64/
